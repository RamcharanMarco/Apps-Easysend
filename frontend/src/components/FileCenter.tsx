...
const FileCenter = () => {
  ...
  const handleClick = (e: any) => {
    e.preventDefault();
    if (!arrayFiles || !emailto || !emailfrom || !message) {
      alert("please engter all files");
      return;
    }
    sendFiles(arrayFiles, emailto, emailfrom, message);
    return;
  };
  ...
  const total = arrayFiles
    ? arrayFiles.reduce((total: any, item: any) => {
    ...
    <div className="addproject">
      ...
      <div className="photoupload">
        ...
        <input
          ...
          multiple
        />
        {(arrayFiles && arrayFiles.length === 0) || files === "" ? (
          <p>no files chosen</p>
        ) : (
          ""
        )}
  ...
  */}
        ...
        {!arrayFiles || !emailto || !emailfrom || !message ? null : (
